...
def command_options():
    ...
    parser.add_argument( '-s0','--screensize0', nargs='?',default='',const='',help='Size of display HDMI0 w*h')
    parser.add_argument( '-s1','--screensize1', nargs='?',default='',const='',help='Size of display HDMI1 w*h')
