...
class HTMLScrolledText(_ScrolledText):
    ...
    def __init__(self, *args, html=None, **kwargs):
        ...
        if isinstance(html, str):
            # krt this will not work as needs pp_home and pp_profile
            self.set_html(html)
    ...
    def set_html(self, html, pp_home,pp_profile,strip=True):
        #------------------------------------------------------------------------------------------
        ...
        self.html_parser.w_set_html(self, html,pp_home,pp_profile, strip=strip)
        #self.config(state=prev_state)

    #krt needed to stop garbage building up
    def delete_parser(self):
        del self.html_parser
...
class HTMLText(HTMLScrolledText):
    ...
    def _w_init(self, kwargs):
        ...
        # KRT remove grey line around html text
